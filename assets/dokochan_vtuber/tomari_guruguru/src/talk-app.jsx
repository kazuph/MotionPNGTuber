  ...
  return (
    <div style={{
      ...
      <div ref={charRef} className="bob" style={{
        ...
        {allFrames.map(({ s, r, c }) => (
          <img key={`${assetBase}-${s}${r}${c}`} src={srcFor(assetBase, s, r, c)} alt="" draggable="false" style={{
      ...
      <div style={{ position: 'absolute', top: '3.5vh', left: 0, right: 0, textAlign: 'center', pointerEvents: 'none' }}>
        <div style={{ fontSize: 'clamp(18px, 2.4vmin, 26px)', fontWeight: 700, color: inkColor, letterSpacing: '0.18em' }}>どこちゃんトーク</div>
